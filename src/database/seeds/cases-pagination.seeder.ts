...
const CLIENTS = [
  {
    ...
    email: 'hartley.pg@paginationseed.test',
    region: 'NSW',
  },
  {
    id: 'b1000000-0000-0000-0000-000000000002',
    name: 'Nguyen Family Holdings',
    email: 'nguyen.fam@paginationseed.test',
    region: 'VIC',
  },
  {
    id: 'b1000000-0000-0000-0000-000000000003',
    name: 'Patel Commercial Pty Ltd',
    email: 'patel.comm@paginationseed.test',
    region: 'QLD',
  },
  {
    id: 'b1000000-0000-0000-0000-000000000004',
    name: 'Marino Developments',
    email: 'marino.dev@paginationseed.test',
    region: 'WA',
  },
  {
    id: 'b1000000-0000-0000-0000-000000000005',
    name: 'Chen Land Trust',
    email: 'chen.land@paginationseed.test',
    region: 'NSW',
  },
  {
    id: 'b1000000-0000-0000-0000-000000000006',
    name: 'Kowalski Investments NSW',
    email: 'kowalski.nsw@paginationseed.test',
    region: 'NSW',
  },
];
...
const STATIC_CASES = [
  // ── Group 1: NSW — future deadlines (cases 01–05) ──────────────────────────
  {
    ...
    case: {
      case_reference: 'SEED-PAG-001',
      status: DisputeStatus.CREATED,
      statutory_deadline: '2026-06-15',
  ...
  },
  {
    ...
    case: {
      case_reference: 'SEED-PAG-003',
      status: DisputeStatus.CREATED,
      statutory_deadline: '2026-07-30',
      jurisdiction: Jurisdiction.NSW,
    },
  },
  {
    ...
    case: {
      case_reference: 'SEED-PAG-004',
      status: DisputeStatus.REPORTS_UPLOADED,
      statutory_deadline: '2026-08-15',
      jurisdiction: Jurisdiction.NSW,
    },
  },
  {
    ...
    case: {
      case_reference: 'SEED-PAG-005',
      status: DisputeStatus.ANALYSED,
      statutory_deadline: '2026-09-01',
      jurisdiction: Jurisdiction.NSW,
    },
  },
  ...
  // ── Group 2: VIC — future deadlines (cases 06–10) ──────────────────────────
  {
    ...
    case: {
      case_reference: 'SEED-PAG-006',
      status: DisputeStatus.ANALYSED,
      statutory_deadline: '2026-09-15',
  ...
  },
  {
    ...
    case: {
      case_reference: 'SEED-PAG-008',
      status: DisputeStatus.TNC_AGREED,
  ...
  },
  {
    ...
    case: {
      case_reference: 'SEED-PAG-009',
      status: DisputeStatus.OBJECTION_SUBMITTED,
      statutory_deadline: '2026-11-01',
      jurisdiction: Jurisdiction.VIC,
    },
  },
  {
  ...
  // ── Group 3: QLD — future deadlines (cases 11–15) ──────────────────────────
  {
    ...
    case: {
      case_reference: 'SEED-PAG-011',
      status: DisputeStatus.VG_RESPONSE_RECEIVED,
  ...
  },
  {
    ...
    case: {
      case_reference: 'SEED-PAG-012',
      status: DisputeStatus.CASE_CLOSED,
      statutory_deadline: '2026-12-15',
      jurisdiction: Jurisdiction.QLD,
    },
  },
  {
    ...
    case: {
      case_reference: 'SEED-PAG-013',
      status: DisputeStatus.VG_AGREED,
      statutory_deadline: '2027-01-15',
      jurisdiction: Jurisdiction.QLD,
    },
  },
  {
    ...
    case: {
      case_reference: 'SEED-PAG-014',
      status: DisputeStatus.CREATED,
      statutory_deadline: '2027-02-01',
      jurisdiction: Jurisdiction.QLD,
    },
  },
  {
    ...
    case: {
      case_reference: 'SEED-PAG-015',
      status: DisputeStatus.REPORTS_UPLOADED,
      statutory_deadline: '2027-02-28',
      jurisdiction: Jurisdiction.QLD,
    },
  },
  ...
  },
  {
    ...
    case: {
      case_reference: 'SEED-PAG-017',
      status: DisputeStatus.REPORTS_UPLOADED,
      statutory_deadline: '2026-08-01',
      jurisdiction: Jurisdiction.WA,
    },
  },
  {
  ...
  },
  {
    ...
    case: {
      case_reference: 'SEED-PAG-020',
      status: DisputeStatus.OBJECTION_SUBMITTED,
      statutory_deadline: '2026-11-30',
      jurisdiction: Jurisdiction.WA,
    },
  },
  ...
  },
  {
    ...
    case: {
      case_reference: 'SEED-PAG-023',
      status: DisputeStatus.AI_FURTHER_SUBMISSION,
      statutory_deadline: '2026-01-15',
      jurisdiction: Jurisdiction.QLD,
    },
  },
  {
    ...
    case: {
      case_reference: 'SEED-PAG-024',
      status: DisputeStatus.CREATED,
      statutory_deadline: '2026-02-15',
      jurisdiction: Jurisdiction.WA,
    },
  },
  {
    ...
    case: {
      case_reference: 'SEED-PAG-025',
      status: DisputeStatus.REPORTS_UPLOADED,
      statutory_deadline: '2026-03-01',
      jurisdiction: Jurisdiction.QLD,
    },
  },
];
...
export async function seedCasesPagination(
  ...
  const DUE_THIS_WEEK_CASES = [
    {
      ...
      case: {
        case_reference: 'SEED-PAG-026',
        status: DisputeStatus.REPORTS_UPLOADED,
        statutory_deadline: isoDatePlusDays(today, 0),
        jurisdiction: Jurisdiction.NSW,
      },
    },
    {
      ...
      case: {
        case_reference: 'SEED-PAG-027',
        status: DisputeStatus.ANALYSED,
        statutory_deadline: isoDatePlusDays(today, 2),
        jurisdiction: Jurisdiction.VIC,
      },
    },
    {
      ...
      case: {
        case_reference: 'SEED-PAG-028',
        status: DisputeStatus.CREATED,
        statutory_deadline: isoDatePlusDays(today, 4),
        jurisdiction: Jurisdiction.QLD,
      },
    },
    {
      ...
      case: {
        case_reference: 'SEED-PAG-029',
        status: DisputeStatus.CREATED,
        statutory_deadline: isoDatePlusDays(today, 5),
        jurisdiction: Jurisdiction.WA,
      },
    },
    {
      ...
      case: {
        case_reference: 'SEED-PAG-030',
        status: DisputeStatus.REPORTS_UPLOADED,
        statutory_deadline: isoDatePlusDays(today, 6),
        jurisdiction: Jurisdiction.NSW,
      },
    },
  ];
    ...
    if (!existingCase) {
      await disputeCaseRepo.save(
        disputeCaseRepo.create({
          ...
          // There is no longer a status for "package sent, awaiting client" or "client
          // approved" — those states are the approval timestamps, so fixtures standing in for
          // them must set these or they become invisible to the approval-reminder cron and to
          // the objection-package badge.
        }),
      );
      logger.log(
        `Seeded dispute case: ${seed.case.case_reference} [${seed.case.status}] deadline ${seed.case.statutory_deadline}`,
      );
    } else {
      logger.log(
  ...
  logger.log('  → 30 cases total across 4 jurisdictions and all 9 statuses');
  logger.log('  → Cases 21–25: OVERDUE (deadline < 2026-04-23)');
  logger.log(
    '  → Cases 26–30: DUE THIS WEEK (deadline 2026-04-24 to 2026-04-30)',
  );
