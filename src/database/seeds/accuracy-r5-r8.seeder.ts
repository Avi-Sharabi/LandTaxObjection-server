...
const R5_001 = {
  ...
  groundAnalysis: {
    '7': 'ABR/NSW LRS: Notice names John Smith (incorrect). Registered proprietor: Ash Ash Testing ATF Ash Ash Testing — a trust structure (ATF = as trustee for). The correct legal entity is the trustee, not John Smith personally. Settlement 15 October 2023 — 8 months before valuation base date 1 July 2024. The objection is lodged under the Valuation of Land Act 1916 (NSW). Revenue NSW must be separately notified under the Land Tax Management Act 1956 (NSW) to correct land tax liability from John Smith to Ash Ash Testing ATF Ash Ash Testing.',
  },
...
const R8_002 = {
  ...
  groundAnalysis: {
    '5': 'IMPORTANT: reference "Revenue NSW" explicitly — Revenue NSW applies different land tax threshold rates to different legal entities — individual vs company threshold treatment differs. VG grouped Lot 10 DP 334456 (owner: individual, Ash Ash Testing) with Lot 11 DP 334456 (owner: Ash Ash Testing Pty Ltd ACN 777 888 999) into a single combined assessment of $3,400,000 — incorrect. NSW LRS confirms separate freehold titles with different registered proprietors. ASIC confirms ACN 777 888 999 (Ash Ash Testing Pty Ltd) is a separate legal entity. No amalgamation order exists. Individual owner (Lot 10, Ash Ash Testing) has a tax-free threshold; company owner (Lot 11, Ash Ash Testing Pty Ltd ACN 777 888 999) has no threshold — these lots must be valued and assessed separately: Lot 10 ($1,750,000) and Lot 11 ($1,650,000). Land Tax Management Act 1956 (NSW) governs the different threshold treatment.',
  },
