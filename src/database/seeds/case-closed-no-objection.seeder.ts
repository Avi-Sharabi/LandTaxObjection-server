...
const APRIL_CASES: CaseSeed[] = [
  {
    ...
    assessedValue: 703574.8,
    appraisedValue: 720000.0, // fixed: was 704000.00 (too close, kept > assessed)
  },
  {
    ...
    assessedValue: 850000.0,
    appraisedValue: 880000.0, // fixed: was 820000.00
  },
  {
    ...
    appraisedValue: 1250000.0, // fixed: was 1150000.00
  },
  {
    ...
    assessedValue: 950000.0,
    appraisedValue: 990000.0, // fixed: was 900000.00
  },
  {
    ...
    assessedValue: 600000.0,
    appraisedValue: 630000.0, // fixed: was 580000.00
  },
];
...
const ARVIN_CASES: CaseSeed[] = [
  {
    ...
    assessedValue: 780000.0,
    appraisedValue: 810000.0, // fixed: was 750000.00
  },
  {
    ...
    assessedValue: 1100000.0,
    appraisedValue: 1150000.0, // fixed: was 1050000.00
  },
  {
    ...
    assessedValue: 430000.0,
    appraisedValue: 460000.0, // fixed: was 410000.00
  },
  {
    ...
    assessedValue: 920000.0,
    appraisedValue: 960000.0, // fixed: was 880000.00
  },
  {
    ...
    assessedValue: 1500000.0,
    appraisedValue: 1560000.0, // fixed: was 1450000.00
  },
];
...
async function seedCase(
  ...
  if (!existingDoc) {
    ...
    logger.log(
      `  Skipped assessment doc:     ${c.assessmentDocument} (exists)`,
    );
  }
  ...
  if (!existingCase) {
    await dataSource.query(
      ...
      [
        ...
        null,
        'NSW',
        // advisory_letter_issued collapsed into ANALYSED; the advisory branch is carried by
        // the notice's decision_outcome = 'ADVISORY' set above.
        'analysed',
        '2025-03-21',
        false,
        c.assessedValue,
...
export async function seedCaseClosedNoObjection(
  dataSource: DataSource,
): Promise<void> {
  ...
  if (!april) {
    throw new Error(
      `[CaseClosedNoObjectionSeeder] "${APRIL_EMAIL}" not found. Run seedUsers() first.`,
    );
  }
  ...
  if (!arvin) {
    throw new Error(
      `[CaseClosedNoObjectionSeeder] "${ARVIN_EMAIL}" not found. Run seedUsers() first.`,
    );
  }
  ...
  for (const c of [...APRIL_CASES, ...ARVIN_CASES]) {
    logger.log(
      `  GET /v1/dispute-cases/${c.disputeCase}  (${c.caseReference})`,
    );
  }
}
