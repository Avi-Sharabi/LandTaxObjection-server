...
export function buildAccContext(p: ScenarioParams): Record<string, unknown> {
  ...
  return {
    ...
    entityEvidence: p.groundAnalysis
      ? {
          groundDocIds: Object.fromEntries(
            Object.keys(p.groundAnalysis).map((k) => [k, []]),
          ),
...
const R1_001: ScenarioParams = {
  seq: 1,
  id: 'ACC-R1-001',
  address: '21 BERNERA RD',
  suburb: 'Prestons',
  postcode: '2170',
  pid: '3042682',
  lotDp: 'Lot 9 DP 1053060',
  lot: '9',
  plan: '1053060',
  assessedValue: 6050000,
  priorValue: 5500000,
  landAreaSqm: 5333,
  zoningCode: 'E5',
  zoningLabel: 'Heavy Industrial',
  concessionMentions: [
  ...
  comparables: [
    {
      address: '18 BERNERA RD PRESTONS NSW 2170',
      area_m2: 5100,
      zone: 'E5',
      analysed_land_value: 5202000,
      rate_per_m2: 1020,
      contract_date: '2024-03-01',
    },
    {
      address: '33 ANZAC AVE PRESTONS NSW 2170',
      area_m2: 4900,
      zone: 'E5',
      analysed_land_value: 4949000,
      rate_per_m2: 1010,
      contract_date: '2024-06-01',
    },
    {
      address: '9 LENORE DR PRESTONS NSW 2170',
      area_m2: 5500,
      zone: 'E5',
      analysed_land_value: 5451500,
      rate_per_m2: 991,
  ...
  reportNotes:
    'E5 Heavy Industrial. Assessed $6,050,000 ($1,134/m2). SEPP No 55 Cockle Creek Smelter contamination overlay — onsite remediation required. Remediation cost $850,000 (XYZ Environmental Engineering Report April 2024). E5 contaminated-site comparables avg $1,007/m2. Argued: $4,295,000.',
  inputDocuments: [
...
const R1_002: ScenarioParams = {
  seq: 2,
  id: 'ACC-R1-002',
  address: '55 CONCORD RD',
  suburb: 'Concord',
  postcode: '2137',
  pid: '4455667',
  lotDp: 'Lot 8 DP 445566',
  lot: '8',
  plan: '445566',
  assessedValue: 1900000,
  priorValue: 1650000,
  landAreaSqm: 630,
  zoningCode: 'R3',
  zoningLabel: 'Medium Density Residential',
  comparables: [
    {
      address: '49 CONCORD RD CONCORD NSW 2137',
      area_m2: 640,
      zone: 'R3',
      analysed_land_value: 1815040,
      rate_per_m2: 2836,
      contract_date: '2024-02-01',
    },
    {
      address: '61 CONCORD RD CONCORD NSW 2137',
      area_m2: 620,
      zone: 'R3',
      analysed_land_value: 1758320,
      rate_per_m2: 2836,
      contract_date: '2024-05-01',
    },
    {
      address: '12 VICTORIA AVE CONCORD NSW 2137',
      area_m2: 650,
      zone: 'R3',
      analysed_land_value: 1843400,
      rate_per_m2: 2836,
  ...
  reportNotes:
    'R3 Medium Density Residential (Canada Bay LEP 2013). Lot 8 DP 445566. VG total assessment $2,800,000 (land + improvements). VG building deduction $900,000 (incorrect) — $2,800,000 − $900,000 = $1,900,000 VG land. QS confirms correct improvements value $1,192,000 → correct land $1,608,000. VG used flat comparables $2,836/m² — steep slope −10% = $2,553/m². Argued value $1,608,000.',
  inputDocuments: [
...
const R1_003: ScenarioParams = {
  ...
  comparables: [
    {
      address: '25 BERNERA RD PRESTONS NSW 2170',
      area_m2: 5200,
      zone: 'E5',
      analysed_land_value: 5720000,
      rate_per_m2: 1100,
      contract_date: '2024-04-01',
    },
    {
      address: '11 INDUSTRIAL AVE PRESTONS NSW 2170',
      area_m2: 5000,
      zone: 'E5',
      analysed_land_value: 5500000,
      rate_per_m2: 1100,
      contract_date: '2024-07-01',
    },
    {
      address: '7 COMMERCE CT PRESTONS NSW 2170',
      area_m2: 5400,
      zone: 'E5',
      analysed_land_value: 5940000,
      rate_per_m2: 1100,
      contract_date: '2024-02-01',
    },
  ],
  ...
  reportNotes:
    'E5 Heavy Industrial. Assessed $6,050,000 ($1,134/m²). VG used stale 2022 comparable rate $1,200/m² — E5 industrial market declined 8% to 1 July 2024. Current comparable rate $1,100/m². Argued value: 5,333 m² × $1,100/m² = $5,866,300.',
  inputDocuments: [
...
const R2_001: ScenarioParams = {
  ...
  landAreaSqm: 600,
  zoningCode: 'R4',
  zoningLabel: 'High Density Residential',
  comparables: [
    {
      address: '38 STATION RD MACQUARIE PARK NSW 2113',
      area_m2: 580,
      zone: 'R4',
      analysed_land_value: 1560200,
      rate_per_m2: 2690,
      contract_date: '2024-02-01',
    },
    {
      address: '11 PITTWATER RD MACQUARIE PARK NSW 2113',
      area_m2: 610,
      zone: 'R4',
      analysed_land_value: 1650050,
      rate_per_m2: 2705,
      contract_date: '2024-05-01',
    },
    {
      address: '7 DELHI RD MACQUARIE PARK NSW 2113',
      area_m2: 590,
      zone: 'R4',
      analysed_land_value: 1580220,
      rate_per_m2: 2678,
...
const R2_002: ScenarioParams = {
  seq: 5,
  id: 'ACC-R2-002',
  address: '2 MARINA VIEW DR',
  suburb: 'Cronulla',
  postcode: '2230',
  pid: '5544331',
  lotDp: 'Lot 1 DP 554433',
  lot: '1',
  plan: '554433',
  ...
  comparables: [
    {
      address: '6 MARINA VIEW DR CRONULLA NSW 2230',
      area_m2: 640,
      zone: 'R2',
    ...
    {
      address: '14 BAY ESPLANADE CRONULLA NSW 2230',
      area_m2: 660,
      zone: 'R2',
      analysed_land_value: 3100000,
      rate_per_m2: 4697,
      contract_date: '2024-04-01',
    },
    {
      address: '9 WATER ST CRONULLA NSW 2230',
      area_m2: 670,
      zone: 'R2',
      analysed_land_value: 3250000,
      rate_per_m2: 4851,
      contract_date: '2024-07-01',
    },
  ],
...
const R3_001: ScenarioParams = {
  ...
  reportNotes:
    'E5 Heavy Industrial. VG Notice records land area as 6,203 m2. Correct area per Deposited Plan DP 1053060 (NSW LRS): 5,333 m2. Area overstated by 870 m2. Assessed rate: $6,050,000 / 6,203 m2 = $975/m2. Correct value: 5,333 m2 * $975/m2 = $5,199,675 (approx $5,200,000). Dollar overcharge: $850,000.',
  inputDocuments: [
...
const R3_002: ScenarioParams = {
  ...
  reportNotes:
    'E5 Heavy Industrial. VG Notice references Lot 10 DP 1053060 (23 Bernera Road, area 7,200 m2, assessed $7,128,000). Correct lot: Lot 9 DP 1053060 (21 Bernera Road, area 5,333 m2). Correct value: 5,333 m2 * $975/m2 = $5,199,675 (approx $5,200,000). Overvaluation: $1,928,000.',
  inputDocuments: [
...
const R4_001: ScenarioParams = {
  ...
  reportNotes:
    'E5 Heavy Industrial (correct zone — Liverpool LEP 2008). VG recorded B2 Local Centre — INCORRECT. Section 10.7 (Liverpool City Council) confirms E5. VG B2 comparables avg $1,800/m2 inapplicable. Correct E5 avg $1,007/m2 * 5,333 m2 = $5,370,000. Zone error: $680,000 overvaluation.',
  inputDocuments: [
...
const R4_002: ScenarioParams = {
  seq: 10,
  id: 'ACC-R4-002',
  address: 'UNIT 12/80 WALKER ST',
  suburb: 'North Sydney',
  postcode: '2060',
  pid: '5544221',
  lotDp: 'Lot 12 SP 77443',
  lot: '12',
  plan: '77443',
  planType: 'SP',
  ...
  reportNotes:
    'R3 Medium Density Residential. Lot 12 SP 77443 (strata lot). VG incorrectly described as freehold lot and applied freehold comparables at $5,333/m² × 600 m² = $3,200,000. NSW LRS confirms strata lot. Correct strata comparables: Unit 6 $1,010,000, Unit 9 $1,025,000 — avg $1,020,000. Overvaluation $2,180,000.',
  inputDocuments: [
...
const R1_004: ScenarioParams = {
  seq: 51,
  id: 'ACC-R1-004',
  address: '77 PROSPECT RD',
  suburb: 'Blacktown',
  postcode: '2148',
  pid: '2234451',
  lotDp: 'Lot 5 DP 223344',
  lot: '5',
  plan: '223344',
  ...
  comparables: [
    {
      address: '81 PROSPECT RD BLACKTOWN NSW 2148',
      area_m2: 800,
      analysed_land_value: 1120000,
      rate_per_m2: 1400,
      contract_date: '2024-03-01',
    },
    {
      address: '79 PROSPECT RD BLACKTOWN NSW 2148',
      area_m2: 790,
      analysed_land_value: 1090000,
      rate_per_m2: 1380,
...
const R1_005: ScenarioParams = {
  seq: 52,
  id: 'ACC-R1-005',
  address: '12 GUMTREE CLOSE',
  suburb: 'Winmalee',
  postcode: '2777',
  pid: '8899771',
  lotDp: 'Lot 3 DP 889977',
  lot: '3',
  plan: '889977',
  ...
  comparables: [
    {
      address: '18 GUMTREE CLOSE WINMALEE NSW 2777',
      area_m2: 1150,
      analysed_land_value: 430000,
      rate_per_m2: 374,
      contract_date: '2024-10-01',
    },
    {
      address: '7 SCRIBBLY GUM DR WINMALEE NSW 2777',
      area_m2: 1200,
      analysed_land_value: 445000,
      rate_per_m2: 371,
      contract_date: '2024-03-01',
    },
  ],
  ...
  reportNotes:
    'R2 Low Density Residential (Blue Mountains LEP 2015). Lot 3 DP 889977. RFS Bushfire prone land — BAL-40. Non-combustible construction required. Blue Mountains land market fell 12% Jul 2023–Jul 2024 (CoreLogic postcode 2777). VG used 2023 pre-decline non-BAL-40 sales averaging $510/m². BAL-40 post-decline comparables avg $373/m². Argued $447,600.',
  inputDocuments: [
...
const R3_003: ScenarioParams = {
  ...
  postcode: '2150',
  pid: '8877661',
  lotDp: 'Lot 101 DP 887766',
  lot: '101',
  plan: '887766',
  assessedValue: 1320000,
  priorValue: 1180000,
  landAreaSqm: 600,
  zoningCode: 'R4',
  zoningLabel: 'High Density Residential',
...
const R3_004: ScenarioParams = {
  seq: 54,
  id: 'ACC-R3-004',
  address: '30 RESERVOIR RD',
  suburb: 'Hornsby',
  postcode: '2077',
  pid: '3344116',
  lotDp: 'Lot 6 DP 334411',
  lot: '6',
  plan: '334411',
  ...
  reportNotes:
    'R2 Low Density Residential (Hornsby LEP 2013). Lot 6 DP 334411. VG recorded area 780 m² — includes 180 m² Sydney Water pipeline easement (3 m wide × 60 m long, no building permitted, title search DP 334411). Correct usable area: 600 m². VG rate: $1,200/m². Correct value: 600 m² × $1,200/m² = $720,000. Overcharge: $216,000.',
  inputDocuments: [
...
const R2_METRO: ScenarioParams = {
  ...
  comparables: [
    {
      address: '16 CROWN ST SURRY HILLS NSW 2010',
      area_m2: 800,
      zone: 'R2',
      analysed_land_value: 2376000,
      rate_per_m2: 2970,
      contract_date: '2024-03-01',
    },
    {
      address: '45 FITZROY ST SURRY HILLS NSW 2010',
      area_m2: 790,
      zone: 'R2',
      analysed_land_value: 2346300,
      rate_per_m2: 2970,
      contract_date: '2024-06-01',
    },
    {
      address: '11 MARLBOROUGH ST SURRY HILLS NSW 2010',
      area_m2: 810,
      zone: 'R2',
      analysed_land_value: 2405700,
      rate_per_m2: 2970,
      contract_date: '2024-01-01',
    },
  ],
...
export async function seedAccuracyR1R4(dataSource: DataSource): Promise<void> {
  ...
  if (!accountant) {
    throw new Error(
      `[AccuracyTestSeeder] "${ACCOUNTANT_EMAIL}" not found — run seedUsers() first.`,
    );
  }
