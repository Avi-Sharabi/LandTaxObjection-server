...
export class AddSiteConstraintsAndDisputeDocuments1774359498191 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "dispute_documents" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "dispute_id" uuid NOT NULL, "document_type" "public"."dispute_documents_document_type_enum" NOT NULL, "filename" text NOT NULL, "blob_storage_url" text NOT NULL, "uploaded_by" uuid, "uploaded_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_37a9c1464e79d9b80c655193292" PRIMARY KEY ("id"))`);
