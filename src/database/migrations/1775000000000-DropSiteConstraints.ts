...
export class DropSiteConstraints1775000000000 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TABLE "site_constraint_documents" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "constraint_id" uuid NOT NULL, "blob_path" text NOT NULL, "uploaded_at" TIMESTAMPTZ NOT NULL DEFAULT now(), CONSTRAINT "PK_site_constraint_documents" PRIMARY KEY ("id"), CONSTRAINT "FK_site_constraint_documents_constraint" FOREIGN KEY ("constraint_id") REFERENCES "site_constraints"("id") ON DELETE CASCADE)`);
