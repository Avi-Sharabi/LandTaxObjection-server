...
export type DisputeCaseListItem = Pick<DisputeCase, 'id' | 'case_reference' | 'client_id' | 'jurisdiction' | 'status' | 'statutory_deadline' | 'original_assessed_value' | 'vg_follow_up_count' | 'reminder_count' | 'is_valuated' | 'created_at'>;
